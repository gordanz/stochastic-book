...
The proof is similar (but more difficult) than the proof of Wald's (first) identity, so we skip it. Instead, here is an application to negative binomial random variables.
