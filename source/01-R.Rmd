...
[https://cran.rstudio.com](https://cran.rstudio.com) and 
...
To install RStudio, go to [https://posit.co/download/rstudio-desktop/](https://posit.co/download/rstudio-desktop/), and follow the instructions under "2: Install RStudio". After you download and install it, you are ready to run it. When it opens, you will see something like this
